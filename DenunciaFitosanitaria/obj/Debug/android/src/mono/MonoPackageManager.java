...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "DenunciaFitosanitaria.dll" comes first in this list. */
		"DenunciaFitosanitaria.dll",
		"DenunciaFitosanicaria.Services.Common.dll",
		"DenunciaFitosanitaria.Data.Common.dll",
